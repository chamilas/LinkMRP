...
{
    public class BatchActivityInstructions
    {
        ...
        private String _ActInstructionMachineCode;

        public String ActInstructionMachineCode
        {
            get { return _ActInstructionMachineCode; }
            set { _ActInstructionMachineCode = value; }
        }
    ...
    public class BatchActivityInstructionsCollec : CollectionBase
    {
        public void Add(BatchActivityInstructions obj)
        {
