...
namespace MRP_GUI
{
    public partial class frmPRPDBatchActivity : System.Windows.Forms.Form
    {

        User CurrentUser = new User();

        public frmPRPDBatchActivity(User objUser,long _PRPDBatchActivityID)
        {
            InitializeComponent();
            CurrentUser = objUser;
        ...
        private void btnMultiple_Click(object sender, EventArgs e)
        {
            try
            {
                frmMultipleLabour_PRPD objForm = new frmMultipleLabour_PRPD(objPRPDBatchActivity,Convert.ToInt32(cmbSections.SelectedValue));
