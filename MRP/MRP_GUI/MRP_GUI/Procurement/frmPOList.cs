...
namespace MRP_GUI
{
    public partial class frmPOList : System.Windows.Forms.Form
    {
        public frmPOList(User objUser,string _POType)
        {
            InitializeComponent();
            POType = _POType;
            CurrentUser = objUser;
        ...
        private void ReLoad(string search)
        {
            try
            {
                ...
                dtPOs = objPO_DL.GetView_Search(POType,search);
        ...
        private void dgvPOs_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgvPOs.CurrentRow.Cells["PONO"].Value != null)
            {
                ...
                frmPODeliveryShedule objForm = new frmPODeliveryShedule(CurrentUser, SelectedPO);
