...
namespace MRP_GUI
{
    public partial class frmBinCards_Packing : System.Windows.Forms.Form
    {
        public frmBinCards_Packing(User objUser, string _TheStore)
        {
            InitializeComponent();
        ...
        private void LoadMaterial()
        {
            try
            {
                DataTable dt = objMaterial_DL.GetDataView("Packing");
        ...
        //{
        //    foreach (DataGridViewRow dr in dgvBinCard.Rows)
        //    {
        //        if (dr.Cells["GRNNO"].Value.ToString() == "0")
        //        {
        //            dr.Cells["GRNNO"].Value = "";
        //        }
        //    }
        //}
    }
