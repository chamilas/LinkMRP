...
namespace MRP_GUI
{
    public partial class frmTGRN_Lab : System.Windows.Forms.Form
    {
        public frmTGRN_Lab(User objUser)
        {
            InitializeComponent();
            CurrentUser = objUser;
        }
        ...
        private void txtMaterial_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                frmMaterialSelection objForm = new frmMaterialSelection("Lab");
...
private void txtSupplier_KeyDown(object sender, KeyEventArgs e)
{
    if (e.KeyCode == Keys.Enter)
    {
        frmSupplierSelection objForm = new frmSupplierSelection("Lab");
        objForm.ShowDialog(this);
