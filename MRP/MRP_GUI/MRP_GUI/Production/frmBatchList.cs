...
namespace MRP_GUI
{
    public partial class frmBatchList : System.Windows.Forms.Form
    {

        User CurrentUser = new User();

        public frmBatchList(User objUser)
        {
            InitializeComponent();
            CurrentUser = objUser;
        }
        ...
        private void Load_Batch_List()
        {
            try
            {
                ...
                DataTable dt = objBatch_DL.Get_DataView(Batch.Status.In_Progress, CurrentUser.UserID);
