...
namespace MRP_GUI
{
    public partial class frmBatchRegister_Rework : System.Windows.Forms.Form
    {

        User CurrentUser = new User();


        public frmBatchRegister_Rework(User objUser)
        {
            InitializeComponent();
            CurrentUser = objUser;
        }
        ...
        private void cmbBatchState_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                dtBatches = objBatch_DL.Get_DataView_Rework((Batch.Status)cmbBatchState.SelectedValue,"Rework","Repack");
