...
namespace MRP_GUI.Sales
{
    public partial class NewCustomer : Form
    {
        ...
        private void load()
        {
            //cmb_territory.DataSource = dl.Territorydata(0);
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                MRP_REF.NewCustomer nc=new MRP_REF.NewCustomer();
                ...
                nc.Area = 1;
                nc.Territory = dl.TerritoryID(cmb_territory.Text.ToString());
                nc.UserID = UserID;
                nc.Status = 0;
                long rows=cr.Add(nc);
