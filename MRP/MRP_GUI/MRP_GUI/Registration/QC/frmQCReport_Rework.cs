...
namespace MRP_GUI
{
    public partial class frmQCReport_Rework : System.Windows.Forms.Form
    {
        public frmQCReport_Rework(User objuser)
        {
            CurrentUser = objuser;
            InitializeComponent();
        }
        ...
        private void Load_Batch_List()
        {
            ...
            try
            {
                dt = objBatch_DL.Get_DataView_ReworkBatchList((int)Batch.Status.QC, "Rework", "Repack");
                     ...
                     if (rbAccept.Checked)
                        {
                            ...
                            objBatch_DL.Update_QCStatus_ForReworkBatches(objBatch.BatchID, CurrentUser.EmployeeID, Batch.Status.QCPass);
        ...
        {
            frmQCReportHistory objFrm = new frmQCReportHistory("Packing");
            objFrm.Show();
        }
    }
}
