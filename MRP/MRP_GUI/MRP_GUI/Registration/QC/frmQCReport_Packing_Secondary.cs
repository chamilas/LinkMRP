...
namespace MRP_GUI
{
    public partial class frmQCReport_Packing_Secondary : System.Windows.Forms.Form
    {
        public frmQCReport_Packing_Secondary(User objuser)
        {
            CurrentUser = objuser;
            InitializeComponent();
        }
                     ...
                     if (rbAccept.Checked)
                        {
                           ...
                           long x= objQCReport_DL.Update_Packing(objQCReport, objBatch.BatchID, CurrentUser.EmployeeID);
                        ...
                        {
                           long x= objQCReport.Status = Convert.ToInt32(QCReport.ReportStatus.Reject);
