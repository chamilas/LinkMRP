...
namespace MRP_GUI
{
    public partial class frmBatchPacking_Priamry_Edit : System.Windows.Forms.Form
    {

        User CurrentUser = new User();

        public frmBatchPacking_Priamry_Edit(User objUser)
        {
            InitializeComponent();
            CurrentUser = objUser;
        }
        ...
        private void dgvActivity_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                if (dgvActivity.CurrentRow != null)
                {
                    ...
                    txtPackingQty.Text = objBatchActivity.StartQty.ToString();
